...
<html lang="en">
  ...
  <head>
    ...
    <!-- Favicons -->
    <link rel="icon" type="image/png" href="<?php echo $path; ?>/web/views/assets/img/favicon.png" />
    ...
    <link href="<?php echo $path; ?>/web/views/assets/css/styles.css" rel="stylesheet" />
  </head>
